...
import dumpReferenceDescriptions from "./dumpReferenceDescriptions";

import dumpReferences from "./dumpReferences";
   ...
   */
    getMethods() {
        if (!this._cache._methods) {
            const components = this.getComponents();
      // we have to require this due to circular dependency with import
            const UAMethod = require("lib/address_space/UAMethod").default;
...
// kind of horrid due to circular reference.....
console.log('exporting basenode!!!!!!!');
export default BaseNode ;
ReferenceType = require("lib/address_space/ReferenceType").default;
