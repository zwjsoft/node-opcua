...
import UATwoStateVariable from "lib/address_space/ua-two-state-variable/UATwoStateVariable";
...
class UAAcknowledgeableConditionBase extends UAConditionBase {
   ...
   */
    ...
    // if you put this at the top it fluns out - odd!
...
export default UAAcknowledgeableConditionBase;
