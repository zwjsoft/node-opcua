...
class ExpandedNodeId extends NodeId {
...
function makeExpandedNodeId(value, namespace) {
    ...
    return new ExpandedNodeId(NodeIdType.NUMERIC, valueInt, namespace || 0, namespaceUri, serverIndex);
}
export default ExpandedNodeId;
export { 
