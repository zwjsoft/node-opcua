...
import ClientSecureChannelLayer from "./ClientSecureChannelLayer";
import {
  GetEndpointsRequest,
...
import { SecurityPolicy, toURI } from "../misc/security_policy";
import {
  make_debugLog,
  checkDebugFlag,
  constructFilename
 ...
 * @constructor
 */
class OPCUAClientBase extends OPCUASecureObject {
    constructor(options = {}) {
   ...
   */
    ...
    _close_pending_sessions(callback) {
      ...
      // istanbul ignore next
        ...
        // xx console.log(self._sessions.map(s => s.authenticationToken.toString()).join(" "));
            }
