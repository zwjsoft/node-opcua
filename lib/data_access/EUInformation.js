...
const makeEUInformation = (symbol, shortName, longName) => new EUInformation({
...
export { 
  EUInformation,  // http://www.unece.org/fileadmin/DAM/cefact/recommendations/rec20/rec20_rev3_Annex2e.pdf
  commonCodeToUInt,
  makeEUInformation,
  standardUnits };
