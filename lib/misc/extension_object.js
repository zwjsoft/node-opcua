...
import {constructObject, registerBuiltInType} from "lib/misc/factories";
import {encodeNodeId, makeNodeId, decodeNodeId} from "lib/misc/encode_decode";
import {isInternalId} from "lib/misc/factoryIdGenerator";
...
function encodeExtensionObject(object, stream) {
    if (!object) {
        ...
        /* istanbul ignore next */
        if (isInternalId(object.encodingDefaultBinary.value)) {
